/*
  # Rebuild get_rankings_safe with correct field names from v_rankings_core

  ## Changes
  - Drops and recreates get_rankings_safe using all fields now available in the 
    rebuilt v_rankings_core view
  - summary_short exposed as its own output column
  - summary_long exposed as its own output column
  - signal_tag added
  - All numeric types consistent (numeric cast in view, no double precision issues)
  - Grants anon/authenticated access
*/
