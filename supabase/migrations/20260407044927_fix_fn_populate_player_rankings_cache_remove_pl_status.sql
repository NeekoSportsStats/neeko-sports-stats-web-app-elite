/*
  # Fix fn_populate_player_rankings_cache — remove pl.status reference

  afl.players has no "status" column — only "manual_status" and "active".
  This migration rewrites the function to derive "status" from manual_status,
  falling back to 'active' when null.
*/
