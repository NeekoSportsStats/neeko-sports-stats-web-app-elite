/*
  # Fix afl.v_player_games_ingestion_gaps — game_start_time column

  game_date in afl.games_raw is already a timestamptz. The prior version
  incorrectly tried to concatenate game_date + game_time as text.
  This migration replaces the view with the corrected column reference.
*/
...
gap_calc AS (
  SELECT
    ...
    gr.status_short,
    gr.game_date                                                      AS game_start_time,
