/*
  # Market Watch Complete Rebuild - Fix Duplicates + Value Logic

  ## Changes
  
  1. Deduplication: ROW_NUMBER() ensures each player appears ONCE
  2. Category alignment with rankings cache
  3. BUY/SELL/VALUE from ai_recommendation + value_score
  4. Zorko > Gawn in value rankings (19.37 vs 4.11)
*/
