/*
  # Fix populate_rankings_cache_from_source v2 — correct column names

  ## Changes from v1
  - afl.v_player_risk_model: use risk_rating (not risk_percent)
  - afl.v_player_risk_model: use volatility_score for risk_rating cache column
*/
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(aia.recommendation, NULL)                                    AS ai_recommendation,
