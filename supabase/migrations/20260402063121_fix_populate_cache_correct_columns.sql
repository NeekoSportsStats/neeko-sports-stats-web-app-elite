/*
  # Fix Populate Rankings Cache - Use Correct Source Columns
  
  ## Problem
  - afl.players only has: player_id, player_name, position_group, active, manual_status
  - No team, position columns
  - Must get team_name, position from player_games
...
BEGIN
  ...
  SELECT
    ...
    pt.position,
    COALESCE(p.position_group, pt.position),
