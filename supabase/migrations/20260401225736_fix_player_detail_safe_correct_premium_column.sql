/*
  # Fix get_player_detail_safe and get_position_players_safe - Correct Premium Column Name

  The functions use `manual_premium_override` but the correct column is `is_manual_premium`.

  Changes:
  1. Fix premium check to use is_manual_premium instead of manual_premium_override
  2. Apply to both get_player_detail_safe and get_position_players_safe
*/

-- ============================================================================
-- Fix get_player_detail_safe - Correct Premium Column
-- ============================================================================
...
DECLARE
  ...
  v_free_ids int[];
BEGIN
  -- Check premium status using correct column: is_manual_premium
...
-- ============================================================================
-- Fix get_position_players_safe - Correct Premium Column
-- ============================================================================
