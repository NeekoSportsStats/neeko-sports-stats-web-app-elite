...
/*
  # Rebuild afl.v_projection_engine_audit — add role change fields

  ## Summary
  Extends the projection engine audit view with two new columns sourced
  from afl.player_role_signals:
  - role_change_score  — 0–100 magnitude of stat pattern shift
  - role_change_flag   — TRUE when score > 25

  All existing columns are preserved in original order.
...
SELECT
  ...
  -- Role change detection columns (new)
