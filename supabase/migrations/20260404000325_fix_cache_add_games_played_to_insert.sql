/*
  # Fix Rankings Cache — Add games_played to INSERT

  ## Summary
  The existing populate_rankings_cache_from_source() function was not including
  games_played in its INSERT statement, leaving it NULL for all rows.
  This migration patches just that column into the function and re-runs it.

  ## Changes
  - populate_rankings_cache_from_source(): adds games_played to column list and SELECT
  - Immediately re-runs the function to populate games_played
*/
...
-- Re-run to backfill games_played
