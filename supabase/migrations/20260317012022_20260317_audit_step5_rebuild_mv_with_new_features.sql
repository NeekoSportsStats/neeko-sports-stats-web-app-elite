...
/*
  # Audit Step 5: Rebuild afl.mv_player_projection with New Feature Columns

  ## Changes
  Adds to the MV:
  - position_concession_multiplier  — from player_projection
  - volatility_score                — from player_projection (sourced from player_variation)
  - stability_score                 — from player_projection
  - ceiling_hit_rate                — from player_variation
  - floor_bust_rate                 — from player_variation
  - stddev_last10                   — from player_variation

  MV is dropped and recreated (DROP CASCADE removes the unique index).
  CONCURRENT refresh index is recreated immediately after.
*/
