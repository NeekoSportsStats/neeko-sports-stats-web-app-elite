/*
  # Fix Edge Board Trap Logic — Lower Risk Threshold

  ## Problem
  Top 150 players by captain_score have max risk_rating of 39.8.
  The trap threshold of risk_rating >= 45 produces 0 rows.
  Pre-season risk scores are compressed (well-modelled players are low risk).

  ## Fix
  Lower trap risk threshold to >= 28 to catch the riskiest of the popular players.
  This is semantically correct: traps are players worth watching carefully,
  not necessarily extremely volatile ones.
*/
