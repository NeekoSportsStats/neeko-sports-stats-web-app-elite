/*
  # Fix populate_mv_edge_board — align INSERT to actual mv_edge_board columns

  ## Problem
  The function references columns in mv_edge_board that don't exist:
  - neeko_rating_scaled, summary_short, recommendation_short, edge_score, edge_tier

  ## Actual mv_edge_board columns:
  ...
  refreshed_at, price_change, price_change_pct

  ## Fix
  Rewrite the function to only SELECT/INSERT columns that exist in mv_edge_board.
  All other logic (eligible filter, trap/captain/breakout CTEs) is preserved.
*/
