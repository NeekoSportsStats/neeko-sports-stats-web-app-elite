-- Fix ambiguous column reference "player_id" in get_social_planner_player_stats
-- PostgreSQL 42702: RETURNS TABLE declares output col "player_id" which conflicts with
-- the AS alias in the final SELECT. Fix: qualify everything via CTE alias r, and
-- drop redundant AS aliases that shadow RETURNS TABLE output column names.
