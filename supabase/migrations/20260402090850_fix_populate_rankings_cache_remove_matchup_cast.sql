/*
  # Fix Populate Rankings Cache - Remove Matchup Rating Cast
  
  ## Problem
  - matchup_rating column in player_rankings_cache is TEXT type
  - Previous migration tried to cast pp.matchup_rating::double precision
  - Error: "invalid input syntax for type double precision: MODERATE"
  
  ## Solution
  - Use pp.matchup_rating directly (text to text)
  - No type cast needed
*/
...
BEGIN
  ...
  SELECT
    ...
    pp.matchup_rating AS matchup_rating,  -- TEXT to TEXT, no cast
