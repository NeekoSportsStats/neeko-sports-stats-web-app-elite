/*
  # Fix Populate Rankings Cache - Correct Team Column Reference
  
  ## Problem
  Function references p.team but afl.players doesn't have that column.
  Need to get team from player_games.team_name instead.
  
  ## Solution
  Rebuild function with correct team reference from player_games.
  Add stronger BYE filtering.
*/
