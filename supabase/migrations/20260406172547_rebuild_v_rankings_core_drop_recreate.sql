/*
  # Rebuild afl.v_rankings_core — drop and recreate with full field set

  ## Changes
  1. Drops the existing view and recreates with all needed fields
  2. Adds signal_tag, summary_short, summary_long as explicit columns
  3. Fixes upside_rating::numeric cast (was double precision)
  4. All numeric fields consistently cast to ::numeric

  ## Security
  - View reads from afl.player_rankings_cache (internal table)
  - All access gated through public RPCs which enforce access control
*/
