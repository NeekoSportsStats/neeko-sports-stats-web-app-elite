...
/*
  # Price Consistency Step 5 — Market Watch: Write prev_price + price_change_pct

  ## Summary
  Rebuilds market.build_market_watch_snapshot() to include prev_price and
  price_change_pct from afl.player_rankings_cache in every snapshot row.
  These fields are now available on market_watch_snapshot_players for use
  in the v_mw_premium view and frontend market watch display.

  ## Changes
  1. Rebuild market.build_market_watch_snapshot() — adds prev_price, price_change_pct
     to the INSERT column list and sourced from player_rankings_cache
  2. Back-fill existing active snapshot rows with price history from cache
*/

-- ============================================================
-- 1. REBUILD build_market_watch_snapshot with price history
-- ============================================================
...
-- ============================================================
-- 2. BACK-FILL active snapshot rows with price history
-- ============================================================
