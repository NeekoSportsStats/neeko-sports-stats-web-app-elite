...
-- Fix admin_get_placeholder_identities to use the same admin guard pattern
-- as all other admin RPCs in this project.
...
GRANT EXECUTE ON FUNCTION public.admin_get_placeholder_identities() TO authenticated;
