/*
  # Add recommendation_strength to public rankings views

  ## Summary
  Drops and recreates v_rankings_master and v_rankings_free to expose
  the new recommendation_strength column (Phase 7).

  ## Changes
  - v_rankings_master: adds recommendation_strength
  - v_rankings_free: adds recommendation_strength (gated to row_rank <= 15)
*/
