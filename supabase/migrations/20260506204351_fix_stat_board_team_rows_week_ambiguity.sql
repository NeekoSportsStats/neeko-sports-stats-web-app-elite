/*
  # Fix get_stat_board_team_rows — ambiguous week column reference

  The DECLARE variable `v_week` clashed with the table column `week` in
  the COALESCE subquery. Rename the local variable and alias subquery columns
