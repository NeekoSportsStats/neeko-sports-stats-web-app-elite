...
const POLICIES = [
  ...
  {
    title: "Contact",
    description: "Get in touch with the Neeko Stats team.",
    updated: null,
    icon: Mail,
    url: "/contact",
  },
...
export default function Policies() {
  ...
  return (
    <>
      <Helmet>
        <title>Policies | Neeko Stats</title>
        <meta name="description" content="Review the terms, privacy and billing policies that apply when using Neeko Stats." />
      ...
      <div className="mb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold mb-3 tracking-tight text-white">Policies</h1>
        <p className="text-white/60 text-sm leading-relaxed max-w-lg">
          Review the terms, privacy and billing policies that apply when using Neeko Stats.
        </p>
      </div>
