...
// Main Operator Console navigation — Marketing Analytics lives inside Users & Growth as a tab.
// /admin/marketing and /admin/marketing-insights remain accessible via direct URL.
export const ADMIN_SECTIONS: AdminSection[] = [
  { path: "/admin/dashboard",      label: "Dashboard",       icon: LayoutDashboard },
  { path: "/admin/health",         label: "Health",          icon: HeartPulse },
  { path: "/admin/users",          label: "Users & Growth",  icon: Users },
