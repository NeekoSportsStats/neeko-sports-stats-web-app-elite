...
import { ArrowRight, ChevronRight, Target, Zap, Check, Crown, TrendingUp, TriangleAlert as AlertTriangle, Lock, Clock as UnlockIcon, ChartBar as BarChart2Icon } from "lucide-react";
...
export default function MobileLanding({ isPremium: _isPremium }: Props) {
  ...
  return (
    <div style={{ background: "#07090d", minHeight: "100dvh" }}>
      ...
      {/* Shared mobile shell — fixed header + drawer */}
      <MobileShell />
