  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="p-6 hover:bg-muted/30 transition-all cursor-pointer group h-full">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold mb-2">EPL Player Stats</h2>
        ...
        <Link to="/sports/epl/teams">
          <Card className="p-6 hover:bg-muted/30 transition-all cursor-pointer group h-full">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold mb-2">EPL Team Stats</h2>
                <p className="text-muted-foreground">
        ...
        <Link to="/sports/epl/ai-analysis">
          <Card className="p-6 hover:bg-muted/30 transition-all cursor-pointer group h-full">
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold mb-2">EPL AI Analysis</h2>
                <p className="text-muted-foreground">
        ...
        <Link to="/sports/epl/match-centre">
          <Card className="p-6 hover:bg-muted/30 transition-all cursor-pointer group h-full">
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold mb-2">EPL Match Centre</h2>
                <p className="text-muted-foreground">
