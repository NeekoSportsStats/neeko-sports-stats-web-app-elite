  ...
  const fetchInsights = async () => {
    try {
      ...
      if (premiumData && !premiumError) {
        ...
        // Create 14 locked placeholders for non-premium users
    ...
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <h1 className="text-3xl md:text-4xl font-bold">AFL AI Analysis</h1>
      ...
      {/* Free Insights Section - 6 blocks */}
      <div>
      ...
      {/* Premium Insights Section - 14 blocks */}
      <div>
