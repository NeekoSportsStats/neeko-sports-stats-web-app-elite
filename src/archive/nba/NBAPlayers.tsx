...
import RoundSummary from "@/components/nba/players/RoundSummary";
import FormStabilityGrid from "@/components/nba/players/FormStabilityGrid";
import PositionTrends from "@/components/nba/players/PositionTrends";
    ...
    <div className="relative min-h-screen">
      ...
      <header className="mb-8 md:mb-10 animate-premium-section">
        ...
        <p className="mt-2 max-w-2xl text-white/70 text-sm leading-relaxed">
          ...
          ledgers — all in one NBA dashboard.
        </p>
      </header>
