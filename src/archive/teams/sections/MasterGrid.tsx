import TeamMasterTable from "@/components/afl/teams/Section-1-master-table/TeamMasterTable";
        ...
        <div className="relative">
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-white/70 leading-relaxed max-w-2xl">
              Complete round-by-round performance data for all teams
            </p>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-white/60">
                Advanced team analytics and predictive modeling
              </p>
            </div>
          </div>
        </a>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-white/60">
                Unlock premium team insights and analytics
              </p>
            </div>
          </div>
        </a>
