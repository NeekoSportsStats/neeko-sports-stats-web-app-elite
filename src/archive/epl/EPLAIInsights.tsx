...
import PredictabilityTable from "@/components/epl/ai-insights/Section-2-player-predictability/PredictabilityTable";
import TeamPredictabilityPanel from "@/components/epl/ai-insights/Section-3-team-prediction/TeamPredictabilityPanel";
import GameFlowMomentumPanel from "@/components/epl/ai-insights/Section-4-game-flow/GameFlowMomentumPanel";
import PlayerImpactScatterPanel from "@/components/epl/ai-insights/Section-1-hero-scatter/PlayerImpactScatterPanel";
    ...
    <div className="relative min-h-screen">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 space-y-12">
        ...
        <header className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">EPL AI Insights</h1>
